...
#ifndef POLYGLOT_IMPORT_TETGEN_MESH_H
#define POLYGLOT_IMPORT_TETGEN_MESH_H

#include "core/mesh.h"
#include "core/point.h"

// This function imports a mesh using .node, .ele, .face, and .neigh files 
...
mesh_t* import_tetgen_mesh(MPI_Comm comm, 
